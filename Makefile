...
FILE_DA_CONSEGNARE=Makefile chatty.c message.h ops.h stats.h config.h \
		   ...
		   connections.c fileManager.c fileManager.h hashManager.c \
		   hashManager.h configSetup.h info_user.h scriptArchivio.sh\
		   threadPoolHandler.c threadPoolHandler.h Relazione_Progetto_SOL.pdf
# inserire il nome del tarball: es. NinoBixio
TARNAME=MicheleMorisco
...
MAIL=michele.morisco94@gmail.com
#
###########################################################
